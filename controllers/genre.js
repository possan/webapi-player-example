(function() {
	...
	module.controller('GenreController', function($scope, $rootScope, API, PlayQueue, $routeParams, Auth) {
		...
		API.getSearchResults('genre:' + $scope.identifier, Auth.getUserCountry()).then(function(results) {
